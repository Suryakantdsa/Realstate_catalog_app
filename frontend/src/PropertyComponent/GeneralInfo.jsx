                ...
                <section className="column">
                    <section className="inputSection">
                        ...
                        <select className="WideInput" type="text" id="Name" name="Name"
                            ...
                            <option value="option2">Dasharathi Aprt.</option>
                            <option value="option3">Panda in&out</option>
                        </select>
                    </section>
                    ...
                    <section className="inputSection">
                        ...
                        <select className="WideInput" type="text" id="PostedBy" name="PostedBy"
                            ...
                            <option value="option2">owner</option>
                            <option value="option3">manger</option>
                        </select>
                    </section>
